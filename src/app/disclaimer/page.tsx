    ...
    <div className="bg-slate-50/40 min-h-screen text-slate-800 font-sans py-12 px-4">
      <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-sm border border-slate-100 p-8 md:p-12">
        ...
        <div className="space-y-6 text-sm text-slate-600 leading-relaxed">
          ...
          <p>
            운영자 성나머은 게재된 콘텐츠의 신뢰도와 정확성을 기하기 위해 최선의 검수를 거치지만, 이에 대한 정확성, 유효성, 안전성 혹은 특정 요건 충족에 대하여 명시적 또는 묵시적으로 어떠한 법적 보증도 하지 않습니다.
          </p>
          ...
          <p>
            이용자가 본 사이트의 안내만을 신뢰하여 행동을 취함에 따라 발생한 불이익, 손해, 직접적 혹은 간접적인 정신적/물질적 피해에 대하여 운영자 성나머은 일체의 민·형사상 법적 책임을 지지 않습니다. 신청 기한 마감 여부나 추가 변경사항은 공식 주최처에 반드시 재확인하시기 바랍니다.
          </p>
