  ...
  return (
    <div className="bg-slate-50/40 min-h-screen text-slate-800 font-sans flex flex-col justify-between">
      ...
      <main className="max-w-6xl mx-auto px-4 py-8 flex-1 w-full">
        {/* 상단 웰컴 배너 */}
        <section className="bg-gradient-to-r from-blue-600 to-indigo-500 rounded-2xl p-6 md:p-8 text-white shadow-md mb-10">
          <h2 className="text-xl md:text-2xl font-bold mb-2">🎉 오늘 우리 동네 소식은 어떨까요?</h2>
          <p className="text-sm md:text-base text-blue-50 opacity-90 leading-relaxed max-w-2xl">
